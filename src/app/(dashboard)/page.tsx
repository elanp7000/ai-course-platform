    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (weeksData) {
                ...
                const formattedWeeks: Week[] = weeksData.map(week => ({
...
function WeekCard({ week, isInstructor, onEdit, onSetCurrent }: { week: Week, isInstructor: boolean, onEdit: () => void, onSetCurrent: () => void }) {
